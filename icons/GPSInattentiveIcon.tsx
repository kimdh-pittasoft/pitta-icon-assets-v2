...
export const GpsInattentiveIcon = (props: React.SVGProps<SVGSVGElement> & { htmlColor?: string, backgroundColor?: string, iconColor?: string, accentColor?: string }) => {
  return (
    <svg width={24} height={24} xmlns="http://www.w3.org/2000/svg" version="1.1" fill="none" viewBox="0 0 40 40" {...props}>
      <defs>

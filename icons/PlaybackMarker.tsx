  ...
  return (
    <svg height="38" width="34" viewBox="0 0 34 38" {...props}>
      <g filter="url(#filter0_d)">
        ...
        />
        <path
          d="M15.1018 11.8224C14.7689 11.6106 14.3333 11.8497 14.3333 12.2442V19.7559C14.3333 20.1504 14.7689 20.3895 15.1018 20.1777L21.0038 16.4219C21.3125 16.2254 21.3125 15.7747 21.0038 15.5782L15.1018 11.8224Z"
          fill="white"
        />
      </g>
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values={`0 0 0 0 ${props.htmlColor ? parseInt(props.htmlColor.slice(1,3), 16)/255 : 0.847059} 0 0 0 0 ${props.htmlColor ? parseInt(props.htmlColor.slice(3,5), 16)/255 : 0.101961} 0 0 0 0 ${props.htmlColor ? parseInt(props.htmlColor.slice(5,7), 16)/255 : 0.14902} 0 0 0 0.45 0`}
          />
          <feBlend
            mode="normal"

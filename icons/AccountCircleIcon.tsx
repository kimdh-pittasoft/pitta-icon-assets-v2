...
export const AccountCircleIcon = (props: React.SVGProps<SVGSVGElement> & { htmlColor?: string }) => {
  
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={props.htmlColor || "#888"} {...props}>

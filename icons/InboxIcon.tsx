...
export const InboxIcon = (props: React.SVGProps<SVGSVGElement> & { htmlColor?: string }) => {
  return (

<svg width="1em" height="1em" viewBox="0 -960 960 960" fill={props.htmlColor || "#0095e0"} {...props}>

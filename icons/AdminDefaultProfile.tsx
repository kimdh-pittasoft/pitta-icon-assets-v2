...
export const AdminDefaultProfile = (props: React.SVGProps<SVGSVGElement> & { htmlColor?: string }) => (
  <svg viewBox="0 0 16 24" fill={props.htmlColor || "#13131C"} {...props}>
    <path
...
export default AdminDefaultProfile;
